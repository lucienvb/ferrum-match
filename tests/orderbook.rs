...
mod orderbook {
    ...
    fn should_match_exact_when_sell_order() {
        ...
        fn should_partial_fill_when_book_buy_order_is_larger() {
            ...
            let trades =
                book.matching_order(OrderBook::make_order_request( 90, 8, Side::Ask));
        ...
        fn should_match_multi_price_levels_when_sell_order() {
            ...
            let trades =
                book.matching_order(OrderBook::make_order_request( 95, 12, Side::Ask));
        ...
        fn should_process_trade_as_buy_order_when_book_is_empty() {
            ...
            let trades =
                book.matching_order(OrderBook::make_order_request( 100, 3, Side::Bid));
        ...
        fn should_process_trade_as_sell_order_when_book_is_empty() {
            ...
            let trades =
                book.matching_order(OrderBook::make_order_request( 99, 6, Side::Ask));
        ...
        fn should_handle_orders_based_on_arrival_sequence() {
            ...
            let trades =
                book.matching_order(OrderBook::make_order_request( 5, 10, Side::Ask));
